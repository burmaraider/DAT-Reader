...
public class INIParser
{
    ...
    public Dictionary<string, Dictionary<string, string>> GetSections { get { return m_Sections; } }

    public Dictionary<string, string> GetSectionsByName(string szName)
    {
        if (m_Sections.TryGetValue(szName, out Dictionary<string, string> value))
        {
            return value;
        }
        else
