...
public static class LTTypes
{
    ...
    public struct LTVector : IEquatable<LTVector>
    {
        ...
        public static implicit operator LTVector((LTFloat x, LTFloat y, LTFloat z) tuple) => new LTVector(
            tuple.x,
            tuple.y,
            tuple.z);
        ...
        public static LTVector operator +(LTVector left, LTVector right) => new LTVector(
            left.X + right.X,
            left.Y + right.Y,
            left.Z + right.Z);
